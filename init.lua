...
local config = {
        ...
        mappings = {
                ...
                n = {
                        ...
                        [",l"] = { ":silent e %:h<CR>" },
                        [',v'] = { ':tabnew $HOME/.config/nvim/lua/user/init.lua<cr>' },
                        [',o'] = { ':lua require("user.utils").close_all()<CR>' },
                        ['<leader>a'] = { "<Cmd>lua require('harpoon.mark').add_file()<CR>" },
                        ['<leader>r'] = { "<Cmd>lua require('harpoon.ui').toggle_quick_menu()<CR>" },
        ...
        plugins = {
                init = {
                        ...
                        { "tamago324/lir.nvim", config = function()
